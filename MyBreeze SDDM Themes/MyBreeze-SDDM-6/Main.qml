    ...
    MouseArea {
        ...
        QQC2.StackView {
            ...
            initialItem: Login {
                ...
                actionItems: [
                       ActionButton {
                        icon.name: "/usr/share/sddm/themes/MyBreeze-SDDM-6/components/artwork/suspend_primary.svg"
                        text: i18ndc("plasma_lookandfeel_org.kde.lookandfeel","Suspend to RAM","Sleep")
                        onClicked: sddm.suspend()
                        enabled: sddm.canSuspend
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/MyBreeze-SDDM-6/components/artwork/restart_primary.svg"
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Restart")
                        onClicked: sddm.reboot()
                        enabled: sddm.canReboot
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/MyBreeze-SDDM-6/components/artwork/shutdown_primary.svg"
                        text: i18nd("plasma_lookandfeel_org.kde.lookandfeel","Shut Down")
                        onClicked: sddm.powerOff()
                        enabled: sddm.canPowerOff
                    },
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/MyBreeze-SDDM-6/components/artwork/other.svg"
        ...
        Component {
            ...
            Login {
                ...
                actionItems: [
                    ...
                    ActionButton {
                        icon.name: "/usr/share/sddm/themes/MyBreeze-SDDM-6/components/artwork/switch_primary.svg"
